...
<div id="fh5co-title-box" style="background-image: url(<?php the_post_thumbnail_url() ?>); background-size: cover; object-fit:cover;" data-stellar-background-ratio="0.5">
    <div class="overlay"></div>
    <div class="page-title">
        <img src="<?php echo get_avatar_url(get_the_author_meta('ID')) ?>" alt="Free HTML5 by FreeHTMl5.co">
